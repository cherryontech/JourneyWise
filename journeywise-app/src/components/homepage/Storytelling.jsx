...
const Storytelling = () => {
  return (
    <div id="storytelling" className="flex flex-row mt-[100px] mb-[113px]">
      <img src="/Rectangle 181.svg" className="relative z-[2]" alt="A close up of five different fists joining together in a circle." /> 
      <section className="ml-[137px]">
        ...
        <Buttons rounded primary className="w-[277px] h=[45px] text-[14px] px-[60px] py-[13px] mt-[30px] relative z-[2]" >BEGIN ASSESSMENT</Buttons> 
      </section>
