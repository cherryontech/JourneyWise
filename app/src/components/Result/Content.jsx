    ...
    return (
        <section className = "mt-[17px]">
            ...
            <figure className = "rounded-[29px] bg-white shadow-lg md:max-w-[1142px] md:max-h-[518px] md:rounded-[29px] md:shadow-[9px_9px_12px_0px_rgba(0,0,0,0.15)] md:mx-[149px]">
              ...
              alt={active === "Iam" ? "pioneer" : "archetype"} />
                ...
                <div className = "text-blackCustom font-features font-serifTex font-normal leading-normal min-w-[295px] min-h-[336px] bg-[#E5F0F7] md:max-w-[574px] md:max-h-[519px] flex:1 rounded-r-[29px] text-wrap">
                    <h3 className = "text-[48px] mt-[84px] mb-[8px] md:min-w-[402px] md:text-[48px] md:mt[126px] md:ml-[59px] md:mr-[112px] md:mb-[27px]" >{active === "Iam"?"The Pioneer":archeType }</h3>
            ...
            <div className="w-[204px] h-[45px] flex-shrink-0 rounded-[55px] border border-black mt-5 mx-auto flex items-center justify-center space-x-2">
                <button className={`w-[112px] h-[37px] flex-shrink-0 rounded-[55px border flex items-center justify-center font-dmSans text-[14px] tracking-[2px] ${active ==="Iam" && " border-black bg-black text-white"} `} onClick = {()=>handleClick("Iam")}>I AM</button>
                <button className={`w-[87px] text-black text-center font-dmSans text-[14px] font-bold leading-normal tracking-[2px]${active ==="Iwas" && " border-black bg-black text-white"}`} onClick={()=>handleClick("Iwas")}>I WAS</button>
            </div>
        </section>
